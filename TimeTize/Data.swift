...
class SharedData: ObservableObject {
    ...
    @Published var tasks = [
        Task(taskName: "Presentation Review", taskStart: Date.now.addingTimeInterval(-500), taskEnd: Date.now.addingTimeInterval(87400), taskRange: "8:00-12:00", repStart: Date.now, repEnd: Date.now, notification: false, tagName: "Personal", searched: false)
    ]
